 ...
 */
template<typename T> class SimpleShapeMesh {
...
public:
	/* constructor */
	SimpleShapeMesh() : topologyType(TRIANGLE_TOPOLOGY) { }
 ...
 */
typedef SimpleShapeMesh<float> SimpleShapeMeshf;
typedef SimpleShapeMesh<double> SimpleShapeMeshd;
